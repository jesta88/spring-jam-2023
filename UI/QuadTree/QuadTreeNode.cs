...
namespace QuadTree
{
    ...
    public class QuadTreeNode<T> where T : IHasRect
    {
        ...
        public List<QuadTreeNode<T>> GetSubNodes => m_nodes;
        ...
        public void Insert(T item)
        {
            ...
            if (!m_bounds.Contains(item.GetRect))
            {
            ...
            foreach (QuadTreeNode<T> node in m_nodes)
            {
                if (node.Bounds.Contains(item.GetRect))
                {
                    node.Insert(item);
                    return;
                }
        ...
        private void CreateSubNodes()
        {
            ...
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(m_bounds.Location, new Point(halfWidth, halfHeight))));
